...
import { apiRequestPasswordReset, apiResetPassword } from '@/lib/services/UserService';
import { z } from 'zod';
        ...
        <div className="relative hidden h-full flex-col justify-between bg-gradient-to-br from-[#C33527] via-[#9E2A1F] to-[#53110C] p-12 text-white lg:flex">
          <div className="space-y-10">
            ...
            <div className="space-y-6">
              <h2 className="text-3xl font-semibold leading-tight md:text-4xl">Reset password?</h2>
              <p className="text-base leading-7 text-white/80">Enter your new password.</p>
            </div>
          </div>
                  ...
                  <div className="space-y-2 text-left">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        {...register('password')}
                        className={cn(
                          'pl-10 pr-10 border-muted focus-visible:ring-[#C33527] focus-visible:ring-offset-2',
