...
import { ComponentIcon, Users, Database } from "lucide-react";
  ...
  return (
    <>
      <Hero
        ...
        capsuleLink="https://github.com"
        title="A Multi-tenant Next.js Starter Template"
        subtitle="Built for developers, by developers. Next.js + Shadcn UI + Xano Backend."
      ...
      <FeatureGrid
        ...
        items={[
          ...
          },
          {
            ...
            title: "Xano Backend",
            description:
              "Powerful backend-as-a-service with database, APIs, and authentication.",
          },
          {
            icon: <Users className="h-12 w-12" />,
            title: "User Management",
            description: "Built-in user authentication and management.",
          },
          {
      ...
      <PricingGrid
        title="Pricing"
        subtitle="Flexible plans for every user."
        items={[
          {
            title: "Basic",
            price: "Free",
          ...
          },
          {
            title: "Pro",
            price: "$0.00",
            description: "Ideal for growing businesses and projects.",
            features: [
              "Full source code",
              "100% Open-source",
              "Community support",
