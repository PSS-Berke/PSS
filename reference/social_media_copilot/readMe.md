Your task is to create a new module. it needs to look similar to the linkedin module in the sence that the main part can be toggled on and off with conditional rendering.
