...
const WebAnalyticsCopilot = () => {
  ...
  const apiData = {
    ...
    settings: {
      ...
      category: 'Wix',
      description:
        'Configure your Wix connection, manage integrations, and control system preferences.',
      cards: [
        {
          id: 'wix-connection',
    ...
    wordpress: {
      ...
      category: 'WordPress',
      description:
        'Welcome to your comprehensive WordPress marketing analytics platform. Navigate through the menu to explore analytics, SEO, e-commerce, customer insights, and automation tools.',
      cards: [
        {
    ...
    'wp-seo-content': {
      ...
      category: 'WordPress',
      description:
        'WordPress SEO optimization and content performance tracking with Yoast and RankMath.',
      cards: [],
    },
    'wp-ecommerce': {
      name: 'E-commerce',
    ...
    'wp-automation-tools': {
      ...
      category: 'WordPress',
      description:
        'WordPress automation plugins, performance monitoring, and integration management.',
      cards: [],
    },
    'wp-settings': {
      name: 'Settings',
    ...
    googleSearchConsole: {
      ...
      category: 'Google',
      description:
        "Monitor your site's presence in Google Search results, track performance, fix indexing issues, and optimize your visibility.",
      cards: [],
    },
    'gsc-analytics-tracking': {
      ...
      description:
        'Track search performance, monitor clicks, impressions, and analyze user behavior in Google Search.',
      cards: [],
    },
    'gsc-seo-content': {
      name: 'SEO & Content',
      category: 'Google Search Console',
      description:
        'Monitor indexing, optimize content, track Core Web Vitals, and ensure mobile usability.',
      cards: [],
    },
    'gsc-ecommerce': {
      name: 'E-commerce',
      category: 'Google Search Console',
      description:
        'Track product performance in Google Search, Shopping tab, and manage Merchant Center integration.',
      cards: [],
    },
    'gsc-customer-insights': {
      ...
      category: 'Google Search Console',
      description:
        'Understand search behavior, analyze user intent, and track discovery performance.',
      cards: [],
    },
    'gsc-automation-tools': {
      ...
      category: 'Google Search Console',
      description:
        'API access, sitemap management, automated reporting, and third-party integrations.',
      cards: [],
    },
    'gsc-settings': {
      name: 'Settings',
      category: 'Google Search Console',
      description:
        'Property settings, user management, verification, and Search Console configuration.',
      cards: [],
    },
    shopify: {
      ...
      category: 'Shopify',
      description:
        'Complete e-commerce analytics and management for your Shopify store. Track sales, manage products, and optimize your online business.',
      cards: [],
    },
    'shopify-analytics-tracking': {
      ...
      category: 'Shopify',
      description:
        'Track store performance, sales analytics, and customer behavior with Shopify Analytics.',
      cards: [],
    },
    'shopify-seo-content': {
      name: 'SEO & Content',
    ...
    referralProgram: {
      ...
      category: 'Growth',
      description:
        'Create and manage referral programs to incentivize customers to bring in new business.',
      cards: [],
    },
  };
    ...
    <div className="flex h-screen bg-gray-50">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">
            ...
            {currentData.category && (
              <span
                className="ml-3 text-sm px-3 py-1 text-white rounded-full font-semibold"
            ...
            return (
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-800 mb-2 group-hover:text-[#C33527] transition-colors">
                      {card.title}
                    </h3>
      ...
      {activeModal && modalData && (
        ...
        >
          ...
          >
            <div
              className="bg-gray-800 text-white px-6 py-4 rounded-t-lg flex justify-between items-center"
              style={{ borderTop: '4px solid #C33527' }}
            >
                      ...
                      {modalData.content.data.rows.map((row, idx) => (
                        <tr key={idx} className={idx % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                          {row.map((cell, cellIdx) => (
                            <td key={cellIdx} className="p-3 border border-gray-300">
                              {cell}
                            </td>
                          ))}
                        </tr>
