...
export const KpiSummaryTable: React.FC<KpiSummaryTableProps> = ({ kpiSummary }) => {
          ...
          <tbody className="[&_tr:last-child]:border-0">
            <tr>
              ...
              <td className="p-4 align-middle [&:has([role=checkbox])]:pr-0">
                {kpiSummary.activeUsers.sum}
              </td>
              <td className="p-4 align-middle [&:has([role=checkbox])]:pr-0">
                {kpiSummary.activeUsers.avg}
              </td>
            </tr>
            <tr>
              <td className="p-4 align-middle [&:has([role=checkbox])]:pr-0">New Users</td>
              <td className="p-4 align-middle [&:has([role=checkbox])]:pr-0">
                {kpiSummary.newUsers.sum}
              </td>
              <td className="p-4 align-middle [&:has([role=checkbox])]:pr-0">
                {kpiSummary.newUsers.avg}
              </td>
            </tr>
            <tr>
              <td className="p-4 align-middle [&:has([role=checkbox])]:pr-0">Screen Page Views</td>
              <td className="p-4 align-middle [&:has([role=checkbox])]:pr-0">
                {kpiSummary.screenPageViews.sum}
              </td>
              <td className="p-4 align-middle [&:has([role=checkbox])]:pr-0">
                {kpiSummary.screenPageViews.avg}
              </td>
            </tr>
            <tr>
              <td className="p-4 align-middle [&:has([role=checkbox])]:pr-0">
              ...
              <td className="p-4 align-middle [&:has([role=checkbox])]:pr-0">
                {kpiSummary.publisherAdClicks.sum}
              </td>
              <td className="p-4 align-middle [&:has([role=checkbox])]:pr-0">
                {kpiSummary.publisherAdClicks.avg}
              </td>
            </tr>
            <tr>
              <td className="p-4 align-middle [&:has([role=checkbox])]:pr-0">
              ...
              <td className="p-4 align-middle [&:has([role=checkbox])]:pr-0">
                {kpiSummary.publisherAdImpressions.sum}
              </td>
              <td className="p-4 align-middle [&:has([role=checkbox])]:pr-0">
                {kpiSummary.publisherAdImpressions.avg}
              </td>
            </tr>
          </tbody>
        </table>
