                ...
                <div className="grid grid-cols-3 gap-3 md:gap-4 mb-4 md:mb-6">
                  {[
                    ...
                    >
                      ...
                      {button.letters && (
                        <span className="text-xs text-muted-foreground mt-0.5 md:mt-1">
                          {button.letters}
                        </span>
                      )}
                    </button>
                    ...
                    <div className="space-y-2">
                      {filteredContacts
                        ...
                        .map((contact) => (
                          <div
                            key={contact.id}
                            className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 p-3 md:p-4 border border-border rounded-xl hover:bg-muted/50 transition-colors"
                          >
                ...
                <div className="space-y-2">
                  {filteredCallLogs.map((log) => {
                    ...
                    return (
                      <div
                        key={log.id}
                        className="flex items-center justify-between gap-3 p-3 md:p-4 border border-border rounded-xl hover:bg-muted/50 transition-colors"
                      >
